...
> 语义说明：本报告中的 MODEL-03 预测随后 7 日完成/逾期结果，并按班内三分位生成测试候选。它验收的是训练、班级校准、发布、教师审核和回滚程序，不是学科掌握模型，报告中的 A/B/C 不得作为正式内容层级。正式方案见[动态分层五轮科学验证与实证研究方案](dynamic_stratification_five_round_validation.md)。
