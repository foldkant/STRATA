...
- 学校级评价方案和评价标准由学校管理员在 `/school-admin/evaluations` 维护，教师端不提供学校级编辑入口。
- 教师在课程或课时中选择本校已发布的评价标准，并根据实际任务完成评分、反馈和必要说明。
- 教师可以调整本次课堂是否开启自评、互评和师评，但不能修改已经发布的学校评价版本。
- 没有足够作品、答案或过程材料时使用“暂不评价”，不能用 0 分或 1 星代替。
- 出勤、签到、积分和在线时长不能直接作为学科评价指标。
- 学生端只显示教师公开的评价要求和本人结果，不显示版本管理、内部分析或隐性分层信息。

完整规则见 [学校评价管理](evaluation_management.md)。
